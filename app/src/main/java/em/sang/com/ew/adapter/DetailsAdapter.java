...
public class DetailsAdapter extends PagerAdapter {
    ...
    public DetailsAdapter (List<SearchBean.ShowapiResBodyBean.CbListBean.ImgListBean> lists, Context context){
        this.cntext=context;
        this.lists=lists;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View view =   View.inflate(cntext, R.layout.item_details,null);
