...
public class BasicAdapter<T> extends RecyclerView.Adapter {
    ...
    public List<CustomBasicHolder> tops = new ArrayList<CustomBasicHolder>();
    public List<CustomBasicHolder> booms = new ArrayList<CustomBasicHolder>();
    ...
    public BasicAdapter(Context context, List<T> lists, int itemID, CustomRecycleListener<T> listener) {
        this.lists = lists;
        this.itemID = itemID;
     ...
     * @param heardHolder 头布局的holder
     */
    public void addHead(int index,CustomBasicHolder heardHolder) {
   ...
   /**
     ...
     * @param topHolder
     */
    public void addTop(CustomBasicHolder topHolder) {
        tops.add(topHolder);
    }
    /**
     * 添加底部刷新局
     ...
     */
    public void addTop(int index,CustomBasicHolder topHolder) {
  ...
  /**
     ...
     * @param boomHolder
     */
    public void addBoom(CustomBasicHolder boomHolder) {
     ...
     */
    public void addBoom(int index,CustomBasicHolder boomHolder) {
    ...
    public boolean isFooter(int position) {
        return position >= heards.size() + lists.size() && position < heards.size() + lists.size() + foots.size()+booms.size();
    }
